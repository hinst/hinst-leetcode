...
* Difficulty: Easy
* Folder name: `combine-two-tables`
* Hint: Learning SQL
* My score:
	* Time: 445 ms, beats 16%

## 176. Second Highest Salary
* Difficulty: Medium
* Folder name: `second-highest-salary`
* Hint: Learning SQL
* My score:
	* Time: 258 ms, beats 59%

## 177. Nth Highest Salary
* Difficulty: Medium
* Folder name: `nth-highest-salary`
* My score:
	* Time: 380 ms, beats 91%

## 178. Rank Scores
* Difficulty: Medium
* Folder name: `rank-scores`
* Hint: yes
* My score:
	* Time: 785 ms, beats 9%
...
## 179. Largest Number
* Difficulty: Medium
* Folder name: `largest-number`
* Hint: no
* My score:
	* Time: 1 ms, beats 93%
	* Memory: 57 MB, beats 92%

## 180. Consecutive Numbers
* Difficulty: Medium
* Folder name: `consecutive-numbers`
* Hint: yes
* My score:
	* Time: 536 ms, beats 47%

## 181. Employees Earning More Than Their Managers
* Difficulty: Easy
* Folder name: `employees-earning-more-than-their-managers`
* Hint: looking up the syntax for inner join
* My score:
	* Time: 333 ms, beats 87%


# My Leetcode. Year 2026

## 182. Duplicate Emails
* Difficulty: Easy
* Folder name: `duplicate-emails`
* My score:
	* Time: 568 ms, beats 5%

## 183. Customers Who Never Order
* Difficulty: Easy
* Folder name: `customers-who-never-order`
* Hint: no
* My score:
	* Time: 555 ms, beats 27%

## 184. Department Highest Salary
* Difficulty: Medium
* Folder name: `department-highest-salary`
* Hint: looking up `join` and `group by` syntax online on W3Schools
* My score:
	* Time: 592 ms, beats 76%

## 185. Department Top Three Salaries
* Difficulty: Hard
* Folder name: `department-top-three-salaries`
* Hint: looking up `rank` calculation online
* My score:
	* Time: 939 ms, beats 45%

Task 186 is hidden behind a paywall.

## 187. Repeated DNA Sequences
* Difficulty: Medium
* Folder name: `repeated-dna-sequences`
* Hint: looking through the comments
* My score:
	* Time: 18 ms, beats 61%
	* Memory: 63 MB, beats 76%

## 188. Best Time to Buy and Sell Stock IV
* Difficulty: Hard
* Folder name: `best-time-to-buy-and-sell-stock-iv`
* I spent over 3 hours trying to complete this task without looking for hints, however I managed to pass 207 test cases online, out of 211. My code had to pass 4 more test cases, but got Time Limit Exceeded. In the end, I had to look for a solution online.
* Hint: https://algo.monster/liteproblems/188
* My score:
	* Time: 52 ms, beats 18%
	* Memory: 87 MB, beats 6%

## 189. Rotate Array
* Difficulty: Medium
* Folder name: `rotate-array`
* Hint: no
* My score:
	* Time: 1 ms, beats 84%
	* Memory: 66 MB, beats 62%

## 190. Reverse Bits
* Difficulty: Easy
* Folder name: `reverse-bits`
* Hint: no
* My score:
	* Time: 51 ms, beats 46%
	* Memory: 57 MB, beats 33%

## 191. Number of 1 Bits
* Difficulty: Easy
* Folder name: `number-of-1-bits`
* Hint: no
* My score:
	* Time: 0 ms, beats 100%
	* Memory: 56 MB, beats 71%

## 192. Word Frequency
* Difficulty: Medium
* Folder name: `word-frequency`
* Hint: reading documentation and StackOverflow answers for BASH programming online
* My score:
	* Time: 53 ms, beats 93%
	* Memory: 3 MB, beats 95%

## 193. Valid Phone Numbers
* Difficulty: Easy
* Folder name: `valid-phone-numbers`
* Hint: reading documentation and StackOverflow answers for Regular Expressions in BASH
	* It turned out that digit character in BASH must be specified as `[0-9]` instead of `\d`
* My score:
	* Time: 66 ms, beats 39%
	* Memory: 3 MB, beats 26%

## 194. Transpose File
* Difficulty: Medium
* Folder name: `transpose-file`
* Hint: reading documentation for arrays in BASH online
* My score:
	* Time: 217 ms, beats 6%
	* Memory: 3 MB, beats 94%

## 195. Tenth Line
* Difficulty: Easy
* Folder name: `tenth-line`
* Hint: looking at my code for previous tasks
* My score:
	* Time: 28 ms, beats 16%
	* Memory: 3 MB, beats 92%

## 196. Delete Duplicate Emails
* Difficulty: Easy
* Folder name: `delete-duplicate-emails`
* Hint: https://stackoverflow.com/questions/45494/mysql-error-1093-cant-specify-target-table-for-update-in-from-clause
* My score:
	* Time: 786 ms, beats 68%

## 197. Rising Temperature
* Difficulty: Easy
* Folder name: `rising-temperature`
* Hint: looking for documentation online. How to subtract one day from date in MySQL.
...
## 198. House Robber
* Difficulty: Medium
* Folder name: `house-robber`
* Hint: no
* My score:
	* Time: 0 ms, beats 100%
	* Memory: 55 MB, beats 40%

## 199. Binary Tree Right Side View
* Difficulty: Medium
* Folder name: `binary-tree-right-side-view`
* Hint: no
* My score:
	* Time: 0 ms, beats 100%
	* Memory: 58 MB, beats 15%

## 200. Number of Islands
* Difficulty: Medium
* Folder name: `number-of-islands`
* Hint: no
* My score:
	* Time: 48 ms, beats 97%
	* Memory: 58 MB, beats 95%

## 201. Bitwise AND of Numbers Range
* Difficulty: Medium
* Folder name: `bitwise-and-of-numbers-range`
* Hint: no
* My score:
	* Time: 10 ms, beats 11%
	* Memory: 65 MB, beats 6%

## 202. Happy Number
* Difficulty: Easy
* Folder name: `happy-number`
* Hint: no
* My score:
	* Time: 1 ms, beats 82%
	* Memory: 55 MB, beats 89%

## 203. Remove Linked List Elements
* Difficulty: Easy
* Folder name: `remove-linked-list-elements`
* Hint: no
* My score:
	* Time: 0 ms, beats 100%
	* Memory: 62 MB, beats 67%

## 204. Count Primes
* Difficulty: Medium
* Folder name: `count-primes`
* Hint: from task description
	* Use the algorithm named Sieve of Eratosthenes
	* The hint on LeetCode included only the name of the algorithm, so I had to search online for the actual steps and read those
* My score:
	* Time: 50 ms, beats 99%
	* Memory: 95 MB, beats 70%

## 205. Isomorphic Strings
* Difficulty: Easy
* Folder name: `isomorphic-strings`
* Hint: no
* My score:
	* Time: 6 ms, beats 68%
	* Memory: 57 MB, beats 26%

## 206. Reverse Linked List
* Difficulty: Easy
* Folder name: `reverse-linked-list`
* Hint: no
* My score:
	* Time: 0 ms, beats 100%
	* Memory: 59 MB, beats 12%

## 207. Course Schedule
* Difficulty: Medium
* Folder name: `course-schedule`
* Hint: read about Depth-first search online
	* Initially I tried to complete the task without hints, but got stuck with Time Limit Exceeded at online test case number 48 of 54
* My score:
	* Time: 9 ms, beats 85%
	* Memory: 62 MB, beats 72%
